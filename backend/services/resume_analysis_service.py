...
from backend.services.resume_pre_llm import structure_resume_date, validate_job_details
...
async def process_resume_analysis(file_bytes: bytes, job_url: str):
    ...
    structured_resume = await structure_resume_date(resume_data=parsed_resume)
